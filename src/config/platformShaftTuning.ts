...
export const platformShaftTuning = {
  ...
  INTRO_SHAFT_PRESS1_DURATION_EASY: 1.5,
  INTRO_SHAFT_PRESS1_DURATION_HARD: 1.15,
  INTRO_SHAFT_PRESS1_TELEGRAPH_EASY: 3,
  INTRO_SHAFT_PRESS1_TELEGRAPH_HARD: 2,
  INTRO_SHAFT_PRESS2_DURATION_EASY: 1.2,
  INTRO_SHAFT_PRESS2_DURATION_HARD: 0.95,
  INTRO_SHAFT_PRESS2_TELEGRAPH_EASY: 2,
  INTRO_SHAFT_PRESS2_TELEGRAPH_HARD: 2,
  ...
  INTRO_SHAFT_CLIMAX_TELEGRAPH_EASY: 3,
  INTRO_SHAFT_CLIMAX_TELEGRAPH_HARD: 2,
